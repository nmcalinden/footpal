...
type Player struct {
	...
	Nickname sql.NullString `json:"nickname" validate:"required,min=2,max=16" db:"nickname" swaggertype:"string"`
...
type PlayerRequest struct {
	...
	PhoneNo  string `json:"phone_no" validate:"required,min=11,max=15"`
